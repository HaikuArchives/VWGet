...
bool VWGetApplication::QuitRequested()
{
	...
	case 2:
		if (server_supports_resume == false) {
			BAlert *xxalert = new BAlert("",
					"Warning, server does not support resuming aborted downloads, your file will be lost if you close connection.",
